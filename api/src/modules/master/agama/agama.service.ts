...
import { AgamaRepository, AgamaEntity } from './agama.repository'
...
@Injectable()
export class AgamaService extends BaseMasterService<
  AgamaEntity,
  CreateAgamaDto,
  UpdateAgamaDto,
  QueryAgamaDto
> {
  constructor(
    protected readonly repo: AgamaRepository,
  ...
  protected async beforeDeleteTx(
    ...
    if (referenced) {
      throw new BadRequestException(
        'Data tidak dapat dihapus karena masih digunakan oleh pegawai'
      )
    }
  }
